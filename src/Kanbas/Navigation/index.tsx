...
export default function KanbasNavigation() {
    return (
        ...
        <LiaBookSolid className="fs-1 text-danger" /><br />Courses</a>
            <a id="wd-calendar-link" href="#/Kanbas/Calendar" className="list-group-item text-center border-0
                   bg-black text-white">
        ...
        <FiInbox className="fs-1 text-danger" /><br />Inbox</a>
            <a id="wd-labs-link" href="#/Labs" className="list-group-item text-center border-0
                   bg-black text-white">
