export default function Lab1() {
    return (
        <div id="wd-lab1">
            ...
            <div id="wd-h-tag">
                ...
                <div id="wd-p-tag">
                    ...
                    <p id="wd-p-1">
                        ...
                        white spaces and render all the text as one single set of sentences.
                        To force the browser to add vertical spacing, wrap the paragraphs you want
                ...
                <div id="wd-lists">
                    ...
                    <ul id="wd-your-books">
                        {/* complete on your own */}
                        <li>Trials of Apollo</li>
                        <li>And Then They Were None</li>
                ...
                <div id="wd-images">
                    ...
                    <br />
                    <img id="wd-teslabot" src="images/teslabot.jpg" height="225" alt="Tesla bot"/>
                </div>
                <div id="wd-forms">
                    <h4>Form Elements</h4>
            ...
            Please
            <a id="wd-github" href="https://github.com/SaumyaGupta907/kanbas-react-web-app">click here</a>
